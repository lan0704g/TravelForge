...
from travel_forge.agents.conversation_agent import TravelForgeConversationAgent
from travel_forge.evaluation.evaluator import evaluate_trip_response, render_score_table
from travel_forge.tools.image_tools import generate_trip_cover_image


st.set_page_config(
    page_title="Agent-TravelForge",
    layout="wide",
...
def get_agent() -> TravelForgeConversationAgent:
    if "trip_agent" not in st.session_state:
        st.session_state.trip_agent = TravelForgeConversationAgent(thread_id="streamlit")
...
st.markdown('<div class="trip-title">Agent-TravelForge</div>', unsafe_allow_html=True)
st.markdown(
