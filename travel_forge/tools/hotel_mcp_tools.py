...
from travel_forge.config import HOTEL_MCP_AUTH_TOKEN, HOTEL_MCP_BACKEND, HOTEL_MCP_URL
from travel_forge.mcp_client import call_mcp_tool
from travel_forge.mcp_client import extract_mcp_json
from travel_forge.mcp_client import get_mcp_server_config
...
def hotel_search_placeholder(city: str, checkin_date: str = "", nights: int = 1) -> str:
    ...
    return (
        ...
        f"{nights} 晚的酒店价格。\n"
        "调试命令：python -m travel_forge.app.list_mcp_tools"
    )
